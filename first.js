    	...
    	if(window.localStorage) {
    		...
    		if(shoppingInfoText != null) {
    			...
    			for(var i = 0; i < shoppingInfoObject.length; i++) {
    				...
    				td6.innerHTML = "<button onclick='deleteAShop(this.parentNode.parentNode)'>删除</button>"//删除栏
        ...
        for(var i = 0; i < getLi.length; i++) {
            getLi[i].onclick = function() {
                ...
                if(isExist == false) {
                    ...
                    var td5HTML = "<input class='number-bt' type='button' value='-'     >";
